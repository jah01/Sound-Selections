...
List<Music> songs = [
  ...
  //Let It All Out (10:05): 16
  Music(
    title: "Let It All Out (10:05)",
    artist: "COIN",
    album: "Dreamland",
    label: "The Committee for Sound and Mind",
    release: DateTime(2019, 11, 15),
    description: "There are not enough good things to say about this song. It feels so relatable and genuine. The best part of the song is the bridge, where a choir does an incredible job of summing up the song. It is the perfect way to end an album, and is probably my favorite song on the album.",
    artistImg: "coin.png",
    artistC: "Fair use",
    albumImg: "Dreamland.jpg",
    albumC: "Fair use",
  ...
  Music(
    ...
    artist: "Broods",
    album: "Evergreen",
    label: "Dryden Street, Island, and UMA",
    release: DateTime(2014, 1, 3),
    description: "Bridges, one of the first and most-popular Broods song, appears on their first EP as well as their debut studio album, Evergreen. Like most Broods songs, this one is powered by Georgia's soprano voice and Caleb's excellent mixing. The song describes a failing relationship where bridges are being burned with \"no way to build it up again.\"",
    artistImg: "broods.jpg",
    artistC: "Fair use",
    albumImg: "evergreen.png",
    albumC: "Fair use",
    category: "Late 2019",
    people: [["Joel Little", "Writer/Producer", "joelLittle.png", "Fair use"]],
    genres: ["electronic", "indie pop"],
    isFeatured: false,
    artistRole: "Artist/Writers",
  ),
  ...
  Music(
    ...
    artist: "benny blanco",
    album: "Graduation",
    label: "Interscope Records and Friends Keep Secrets",
    release: DateTime(2019, 8, 30),
    description: "Graduation is a great rap song that infuses other musical elements such as classical music and guitar. Featuring Juice WRLD, this bop explains growing up and how high school doesn't really matter to him anymore.",
    artistImg: "bennyBlanco.png",
    artistC: "© Matt Adam. Used under Creative Commons.",
    albumImg: "graduation.png",
    albumC: "Fair use",
    category: "Late 2019",
    people: [["Juice WRLD", "Featured/Writer", "juice.png", "Fair use"], ["Happy Perez", "Producer", "empty.png", null], ["Cashmere Cat", "Producer", "cashmereCat.png", "Fair use"]],
    genres: ["rap"],
    isFeatured: false,
    artistRole: "Artist/Writer/Producer",
  ),
  ...
  Music(
    ...
    label: "Universal Music Group and Republic Records",
    release: DateTime(2019, 9, 6),
    description: "Saint-Tropez is just one of the many great songs Post has released the past few years. It's a song where Post brags about what he has and how he's grown. Via Spotify, he has said, \"it’s a celebration of life instead of an introspective kind of [song].\"",
    artistImg: "postMalone.png",
    artistC: "This file is licensed under the Creative Commons Attribution 3.0 Unported license. Attribution: Cosmopolitan UK.",
    albumImg: "hollywoodsBleeding.png",
    albumC: "Fair use",
    category: "Late 2019",
    people: [],
    genres: ["r&b"],
    isFeatured: false,
    artistRole: "Artist/Co-writer",
  ),
  //Wanted: 20
  Music(
    title: "Wanted",
    artist: "One Republic",
    album: "Human",
    label: "Mosley Music Group and Interscope Records",
    release: DateTime(2019, 9, 6),
    description: "Fast-paced and written brilliantly, Wanted is a great story of a person who needs to be \"somebody that somebody needs.\" It's always nice to hear a song that hits home, because doesn't everybody wanna be wanted?",
    artistImg: "oneRepublic.jpg",
    artistC: "Fair use",
    albumImg: "human.jpg",
    albumC: "Fair use",
    category: "Late 2019",
  ...
  Music(
    ...
    albumC: "Fair use",
    category: "Late 2019",
    people: [["Frederik Thaae", "Co-writer/Producer", "empty.png", null]],
    genres: ["energetic"],
    isFeatured: false,
    artistRole: "Artist",
  ),
